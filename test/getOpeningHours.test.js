...
describe('Testes da função getOpeningHours', () => {
  ...
  it('ao passar os argumentos Monday e 13:00-AM deve lançar uma exceção com a mensagem de erro', () => {
    expect(getOpeningHours('Monday', '13:00-AM')).toThrow('The hour must be between 0 and 12');
  });
  it('ao passar os argumentos Tuesday e 09:60-AM deve lançar uma exceção com a mensagem de erro', () => {
